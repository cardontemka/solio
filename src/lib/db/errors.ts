...
const BY_MESSAGE: Record<string, string> = {
  ...
  COUNTERPARTY_ALREADY_CONFIRMED:
    'Нөгөө тал биечлэн авсныг баталгаажуулсан тул хаах боломжгүй. Та ч бас баталгаажуулна уу.',
  SWAPS_ARE_NOT_CANCELLED:
    'Солилцоог цуцлах боломжгүй. Санал болгосон бол дуусгах, эсвэл нөгөө тал нь татгалзах ' +
    'хүртэл хүлээнэ үү.',
  // Confirming a handover
  NO_ACTIVE_SWAP_FOR_ITEM:
    'Энэ зүйл идэвхтэй солилцоонд байхгүй байна. Солилцоо хийгээгүй бол авсан гэж ' +
    'бүртгүүлэх хэсгийг ашиглана уу.',
  NOT_THE_RECEIVING_SIDE:
    'Энэ бол таны өгч буй зүйл. Хүлээн авсан зүйлийнхээ шошгыг уншуулна уу.',

  // Codes and claims
  ITEM_CODE_NOT_FOUND:
    'Ийм кодтой ном, пянз олдсонгүй. Кодоо шалгаад дахин оруулна уу.',
  ITEM_NOT_AVAILABLE: 'Энэ зүйл одоогоор боломжгүй байна.',
  ALREADY_YOURS: 'Энэ зүйл аль хэдийн таных байна.',
  ITEM_IN_ACTIVE_SWAP:
    'Энэ зүйл идэвхтэй солилцоонд байна. Солилцоо дуустал шилжүүлэх боломжгүй.',
  ITEM_ALREADY_CLAIMED: 'Энэ зүйл дээр өөр хүний хүсэлт хүлээгдэж байна.',
  NOT_A_STORAGE_POINT:
    'Хадгалж авахын тулд хадгалах цэгээр бүртгүүлсэн байх шаардлагатай.',
  RATE_LIMIT_CLAIM: 'Өдөрт хийх хүсэлтийн хязгаарт хүрлээ. Маргааш дахин оролдоно уу.',
  CLAIM_NOT_FOUND: 'Энэ хүсэлт олдсонгүй.',
  CLAIM_ALREADY_RESOLVED: 'Энэ хүсэлт аль хэдийн шийдэгдсэн байна.',
  CLAIM_EXPIRED: 'Энэ хүсэлтийн хугацаа дууссан байна. Дахин илгээхийг хүснэ үү.',
  ONLY_OWNER_MAY_DECIDE: 'Зөвхөн эзэмшигч нь шийдэх боломжтой.',
  ONLY_CLAIMANT_MAY_CANCEL: 'Зөвхөн хүсэлт илгээгч нь буцаах боломжтой.',
  OWNERSHIP_CHANGED_SINCE_CLAIM:
    'Хүсэлт илгээснээс хойш энэ зүйлийн эзэмшигч өөрчлөгдсөн байна.',
  UNKNOWN_CLAIM_KIND: 'Буруу хүсэлт.',
  UNKNOWN_CLAIM_ACTION: 'Буруу үйлдэл.',
