...
const BY_MESSAGE: Record<string, string> = {
  ...
  AWAITING_COUNTERPARTY_CONFIRMATION: 'Нөгөө талын баталгаажуулалтыг хүлээж байна.',
  OWNERSHIP_OR_STATUS_MISMATCH: 'Солилцоон дахь ном өөрчлөгдсөн байна. Хуудсаа шинэчилнэ үү.',
